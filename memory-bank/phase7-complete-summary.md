...
**トピック・エンティティ抽出（✅ 5/5完了 2025-10-12）:**
...
### API使用量（無料枠内）
- Gemini Audio API: 5回（全ファイル文字起こし完了）
- Gemini 2.5 Pro: 5回（全ファイルトピック抽出完了）
- Gemini Embeddings: 4,209回（全ファイルベクトル化完了、44バッチ）
- **合計コスト:** $0
