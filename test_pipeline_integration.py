...
def test_imports():
    ...
    test_cases = [
        ("Step 1: Transcribe", "from src.step1_transcribe.structured_transcribe import main"),
        ("Step 2: Participants DB", "from src.step2_participants.participants_db import ParticipantsDB"),
        ("Step 2: Extract Participants", "from src.step2_participants.extract_participants import extract_participants_from_description"),
        ("Step 2: Speaker Inference", "from src.step2_participants.enhanced_speaker_inference import infer_speakers_with_participants"),
        ("Step 2: Integrated Pipeline", "from src.step2_participants.integrated_pipeline import run_phase_11_3_pipeline"),
        ("Step 3: Topics/Entities", "from src.step3_topics.add_topics_entities import main"),
        ("Step 4: Entity Resolution", "from src.step4_entities.entity_resolution_llm import main"),
        ("Step 5: Vector DB", "from src.step5_vector_db.build_unified_vector_index import main"),
        ("Step 6: Semantic Search", "from src.step6_search.semantic_search import main"),
        ("Step 6: RAG QA", "from src.step6_search.rag_qa import main"),
        ("Step 7: File Management", "from src.step7_file_management.generate_smart_filename import generate_filename_from_transcription"),
        ("Step 7: Cloud Manager", "from src.step7_file_management.cloud_file_manager import delete_gdrive_file"),
        ("Step 7: Unified Registry", "from src.step7_file_management.unified_registry import is_processed"),
